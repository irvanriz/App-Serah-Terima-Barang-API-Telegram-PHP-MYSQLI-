...
<html>
    ...
    <body>
        ...
        <tbody>
            ...
            $sql1 = "SELECT * FROM penerimaan group by id desc";
            $result = mysqli_query($link, $sql1);
            $total = mysqli_num_rows($result);

            $pages = ceil($total/$halaman);       

            $sql2 = "select * from penerimaan group by id asc LIMIT $mulai, $halaman";
            ...
            <tr>
                ...
                <td><?php $tgl_penerimaan = $mas ['tgl_penerimaan'];echo date ("d/M/Y", strtotime($tgl_penerimaan)) ?></td>
